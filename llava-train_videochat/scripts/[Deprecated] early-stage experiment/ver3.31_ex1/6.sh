...
STAGE_ID="6"
EXP_NAME="extreme"
DATA_VERSION="data/reversed/stage3_short-long_mix_sft_rev_large2.yaml"
#--------------------
...
LLM_VERSION="/home/ec2-user/workspace/VideoChat-Flash-forked/llava-train_videochat/checkpoints/$EXP_NAME/stage5-umt-hd-large-tome16_mlp_hd64_Qwen2_5_1_5B_stage3_short-long_mix_sft_rev_mid2.yaml"
...
ACCELERATE_CPU_AFFINITY=1 torchrun --nproc_per_node=${NUM_GPU} --master_port=29500 \
