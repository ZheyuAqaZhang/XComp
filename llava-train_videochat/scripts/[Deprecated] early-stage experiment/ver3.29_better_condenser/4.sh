...
DATA_VERSION="data/stage3_short-long_mix_sft_small3.yaml"
#--------------------
...
LLM_VERSION="/home/ec2-user/workspace/VideoChat-Flash-forked/llava-train_videochat/checkpoints/$EXP_NAME/stage3-umt-hd-large-tome16_mlp_hd64_Qwen2_5_1_5B_stage3_short-long_mix_sft_mid.yaml/"
