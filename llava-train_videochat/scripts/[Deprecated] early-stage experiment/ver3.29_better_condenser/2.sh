...
DATA_VERSION="data/stage2_short_pretrain_iv6m_mid.yaml"
#--------------------
...
LLM_VERSION="/home/ec2-user/workspace/VideoChat-Flash-forked/llava-train_videochat/checkpoints/$EXP_NAME/stage1-umt-hd-large-tome16_mlp_hd64_Qwen2_5_1_5B_stage1_init_connector_iv1m.yaml"
