...
# Most Important Part
STAGE_ID="ab_same_length"
EXP_NAME="baseline_1000frame_cos_ablt"
DATA_VERSION="data/stage3_short-long_mix_sft_mid2.yaml"
# DATA_VERSION="data/dlc_data.yaml"
#--------------------

export EXTRA_PARAM_START_RATIO="0"
export EXTRA_PARAM_END_RATIO="0.25"

# Hyperparameters
# export EXTRA_PARAM_OVERWRITE_DROP_SCHEDULE="Cosine"  # must nexthalf, and without EXTRA_PARAM_INNER_STRIDE_LIST
...
LLM_VERSION="/home/ec2-user/workspace/VideoChat-Flash-forked/llava-train_videochat/checkpoints/baseline_1000frame_cos/stagesuf-umt-hd-large-tome16_mlp_hd64_Qwen2_5_1_5B_stage3_short-long_mix_sft_mid2.yaml"
