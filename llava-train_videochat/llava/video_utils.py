...
def get_frame_indices(num_frames, vlen, sample='middle', fix_start=None, input_fps=1, min_num_frames=1, max_num_frames=-1, local_num_frames=8):
    if num_frames < local_num_frames:
        print(f'warning: num_frames < local_num_frames, num_frames={num_frames}, local_num_frames={local_num_frames}')
        local_num_frames = 8
        print(f'local_num_frames set to {local_num_frames}')
